...
class WineriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create winery" do
    assert_difference('Winery.count') do
      post wineries_url, params: { winery: { location: @winery.location, name: @winery.name } }
    end
  ...
  test "should update winery" do
    patch winery_url(@winery), params: { winery: { location: @winery.location, name: @winery.name } }
